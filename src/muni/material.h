  ...
  struct Microfacet
  {
    ...
    */
    Vec3f F(Vec3f wi) const
    {
      // =============================================================================================
      // TODO: Implement this function
      Vec3f R0 = (n1 - n2) * (n1 - n2) / ((n1 + n2) * (n1 + n2));
      float cos_theta = wi.z;
      Vec3f ans_F = R0 + (Vec3f{1.0f} - R0) * (float)pow(1.0f - cos_theta, 5.0f);
      return ans_F;
      // =============================================================================================
    }
    ...
    */
    Vec3f eval(Vec3f wo_world, Vec3f wi_world, Vec3f normal) const
    {
      ...
      tot_D += ans_D;
      cnt++;
      Vec3f ans = ans_F * ans_G * ans_D / (4.0f * dot(wo, Vec3f{0.0f, 0.0f, 1.0f}) * dot(wi, Vec3f{0.0f, 0.0f, 1.0f}));
      return ans;
      // =============================================================================================
    }
